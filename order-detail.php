...
$cnt=$cnt+1; 
 ...
 ?> -->
							<td class="qnt">1</td>
							<td class="total"><?php  echo $total=$price;?></td>
...
$cnt=$cnt+1; 
 ...
 ?>
				...
				<div class="total-count">
					<h4>Subtotal: Rs.<?php  echo $totprice;?></h4>
					<!-- <p>+shippment: Rs.<?php  echo $shippingtotal;?></p> -->
					<h3>Total to pay: <strong>Rs.<?php echo $grandtotal;?></strong></h3>
